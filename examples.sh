...
python3 tile2scheme.py --outfile work/wfc-flowers_i.scheme --tilefile work/wfc-flowers_i.tile --countdivs 1 1 --pattern noout-bl-3
...
python3 tile2scheme.py --outfile work/wfc-skyline_i.scheme --tilefile work/wfc-skyline_i.tile --countdivs 1 1 --pattern noout-bl-3
python3 scheme2output.py --outfile work/wfc-skyline_i --schemefile work/wfc-skyline_i.scheme --size 15 15

# cave
python3 input2tile.py --outfile work/cave_ti.tile --textfile levels/kenney/cave.lvl --imagefile levels/kenney/cave.png --tilesize 16
python3 tile2scheme.py --outfile work/cave_ti.scheme --tilefile work/cave_ti.tile --countdivs 1 1 --pattern nbr-plus
...
# tomb
python3 input2tile.py --outfile work/tomb-1_ti.tile --textfile levels/manual/tomb-1.lvl --imagefile levels/manual/tomb-1.png --tilesize 12
...
python3 tile2scheme.py --outfile work/supercat-1-7_t.scheme --tilefile work/supercat-1-7_t.tile --countdivs 5 5 --pattern diamond
...
python3 tile2scheme.py --outfile work/mario-1-1_i_ring.scheme --tilefile work/mario-1-1_i_ring.tile --countdivs 7 10 --pattern nbr-l
...
python3 tile2scheme.py --outfile work/mario-1-1_t_gram.scheme --tilefile work/mario-1-1_t_gram.tile --countdivs 1 1 --pattern 3gc
...
python3 tile2scheme.py --outfile work/mario-1-1_i_gram.scheme --tilefile work/mario-1-1_i_gram.tile --countdivs 7 10 --pattern nbr-l
...
python3 tile2scheme.py --outfile work/kidicarus-1_t_ring.scheme --tilefile work/kidicarus-1_t_ring.tile --countdivs 1 1 --pattern ring
...
python3 tile2scheme.py --outfile work/kidicarus-1_i_ring.scheme --tilefile work/kidicarus-1_i_ring.tile --countdivs 10 4 --pattern nbr-l
...
python3 tile2scheme.py --outfile work/kidicarus-1_t_gram.scheme --tilefile work/kidicarus-1_t_gram.tile --countdivs 1 1 --pattern 2gr
...
python3 tile2scheme.py --outfile work/kidicarus-1_i_gram.scheme --tilefile work/kidicarus-1_i_gram.tile --countdivs 10 4 --pattern nbr-l
...
python3 tile2scheme.py --outfile work/super-mario-land-11_t.scheme --tilefile work/super-mario-land-11_t.tile --countdivs 1 1 --pattern diamond
...
python3 tile2scheme.py --outfile work/super-mario-land-11_i.scheme --tilefile work/super-mario-land-11_i.tile --pattern block2 # --countdivs 8 10
...
# zelda
python3 input2tile.py --outfile work/tloz1-1_ti.tile --textfile levels/vglc/tloz1-1-doors.lvl --imagefile levels/vglc/tloz1-1.png --tilesize 16
python3 tile2scheme.py --outfile work/tloz1-1_ti.scheme --tilefile work/tloz1-1_ti.tile --pattern zgc # --countdivs 6 6
...
# mario tests
python3 input2tile.py --outfile work/mario-1-1-TEST_t.tile --textfile levels/vglc/mario-1-1-generic.lvl
python3 tile2scheme.py --outfile work/mario-1-1-TEST_t.scheme --tilefile work/mario-1-1-TEST_t.tile --countdivs 1 1 --pattern ring
