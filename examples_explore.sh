...
python explore2pdf.py --outfile work/tiny_t.pdf --explorefile work/tiny.explore --text
python explore2pdf.py --outfile work/tiny_i.pdf --explorefile work/tiny.explore --image
python app_explorer.py --test --explorefile work/tiny.explore
...
python explore2pdf.py --outfile work/tiny-text_t.pdf --explorefile work/tiny-text.explore --text
python app_explorer.py --test --explorefile work/tiny-text.explore
...
python explore2pdf.py --outfile work/tiny-image_i.pdf --explorefile work/tiny-image.explore --image
python app_explorer.py --test --explorefile work/tiny-image.explore
...
python explore2pdf.py --outfile work/tiny-tiles_t.pdf --explorefile work/tiny-tiles.explore --text
python explore2pdf.py --outfile work/tiny-tiles_i.pdf --explorefile work/tiny-tiles.explore --image
python app_explorer.py --test --explorefile work/tiny-tiles.explore
...
python explore2pdf.py --outfile work/cave_t.pdf --explorefile work/cave.explore --text
python explore2pdf.py --outfile work/cave_i.pdf --explorefile work/cave.explore --image
python app_explorer.py --test --explorefile work/cave.explore
