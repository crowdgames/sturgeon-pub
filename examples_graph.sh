...
python gdesc2graph.py --outfile work/test-nolabel-utree.dot --gdescfile work/test-nolabel-utree.gd --solver pysat-minicard --minsize 10 --maxsize 15 --edgeopt tri
...
python gdesc2graph.py --outfile work/test-nolabel-dtree.dot --gdescfile work/test-nolabel-dtree.gd --solver pysat-minicard --minsize 10 --maxsize 15 --edgeopt tri
...
python gdesc2graph.py --outfile work/fract.dot --gdescfile work/fract.gd --solver z3-slv --connect layer --minsize 8 --maxsize 10 --edgeopt band 4 --label-min m=1 s=1 '1>=2'

# loops and lengths
python graph2gdesc.py --outfile work/test-chain-tri.gd --graphfile levels/graphs/test-chain-tri.gr --nrad sub1
python gdesc2graph.py --outfile work/test-chain-tri.dot --gdescfile work/test-chain-tri.gd --solver pysat-minicard --minsize 20 --maxsize 30 --edgeopt band 5
...
python gdesc2graph.py --outfile work/test-chain-loop-cn.dot --gdescfile work/test-chain-loop.gd --solver z3-slv --minsize 20 --maxsize 30 --edgeopt band 5 --cycle-no
python gdesc2graph.py --outfile work/test-chain-loop-cy.dot --gdescfile work/test-chain-loop.gd --solver z3-slv --minsize 20 --maxsize 30 --edgeopt band 5 --cycle-yes

python graph2gdesc.py --outfile work/snake.gd --graphfile levels/graphs/snake.gr --edge-polar
python gdesc2graph.py --outfile work/snake.dot --gdescfile work/snake.gd --solver z3-slv --minsize 10 --maxsize 10 --edgeopt band 2
...
python gdesc2graph.py --outfile work/mol-cn.gr --gdescfile work/mol.gd --solver z3-slv --minsize 5 --maxsize 10 --edgeopt band 4 --cycle-no
python gdesc2graph.py --outfile work/mol-cy.gr --gdescfile work/mol.gd --solver z3-slv --minsize 5 --maxsize 10 --edgeopt band 4 --cycle-yes
