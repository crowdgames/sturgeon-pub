...
python gdesc2graph.py --outfile work/fract.dot --gdescfile work/fract.gd --solver z3-slv --connect layer --minsize 10 --maxsize 14 --edgeopt band 4 --label-min m=1 s=1 '1>=2'
